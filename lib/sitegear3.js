...
(function (_, path, connect, express, redis, mergeDescriptors, utils, defaults) {
	...
	module.exports = function () {
		...
		app.setupRoutes = function () {
			app.get('/', app.controllers.default().page());
			app.get('/about', app.controllers.default().page());
			app.get('/about/board', app.controllers.default().page());
			app.get('/contact', app.controllers.default().page());
//			app.post('/contact', app.controllers.forms().form('contact'));
			app.get('/contact/thankyou', app.controllers.default().page());
			return app;
		};
		app.start = function () {
