...
}(require('lodash'), require('path'), require('http'), require('https'), require('connect'), require('express'), require('redis'), require('./storage'), require('./utils'), require('./defaults.json')));
