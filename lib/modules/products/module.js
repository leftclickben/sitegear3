...
(function (_, schemaValidator) {
	...
	module.exports = function (app) {
		var categoryRepository = app.storage.define('productCategory', schemaValidator(require('./schema/category.schema.json'))),
			itemRepository = app.storage.define('productItem', require('./models/item'), schemaValidator(require('./schema/item.schema.json')));
...
}(require('lodash'), require('../../validators/schema')));
