...
(function (_) {
	...
	module.exports = function (app) {
		var categoryRepository = app.storage.define('productCategory', require('./schema/category.schema.json')),
			itemRepository = app.storage.define('productItem', require('./schema/item.schema.json'));
