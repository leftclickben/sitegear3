...
(function (_, path, glob) {
	...
	module.exports = {
		 ...
		 *
		 * loadPathAsGetters(myObject, globPattern, namePattern, function () { ... });
		 * loadPathAsGetters(globPattern, namePattern, function () { ... });
		 * loadPathAsGetters(myObject, globPattern, function () { ... });
		 * loadPathAsGetters(globPattern, function () { ... });
		 *
		 ...
		 * @param callback
		 */
		loadPathAsGetters: function (destination, globPattern, namePattern, callback) {
