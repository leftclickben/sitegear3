	...
	module.exports = function () {
		...
		return _.extend(app, {
			...
			module: function (name) {
				if (!module.exports.modules.hasOwnProperty(name) || !_.isFunction(module.exports.modules[name])) {
					throw new Error('Attempting to retrieve unknown module "' + name + '"');
				}
				if (!app.modules.hasOwnProperty(name)) {
					app.modules[name] = module.exports.modules[name](app);
				}
